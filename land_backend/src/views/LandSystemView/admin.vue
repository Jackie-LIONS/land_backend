<template>
    <div>
        ...
        <span class="title-info">全部管理员</span>
    </div>
    <a-button status="success"  @click="showAddModal">
     ...
     <!-- 这里是添加的弹窗组件 -->
     <add-info-modal ref="addInfoModal" @refreshList="getCategorys"></add-info-modal>
...
import AddInfoModal from "./component/AddInfoModal.vue";  // 引入新增弹窗组件
...
</style>./component/AddInfoModal.vue
